...
export const getMasterchefContract = (poolAddress: string, signer?: Signer | Provider) => {
  return getContract({ abi: masterChef, address: poolAddress, signer }) as Masterchef
}
