import { ChainId, Pair, ERC20Token } from '@verto/sdk'
...
import { useWeb3LibraryContext } from '@verto/wagmi'
...
export function toV2LiquidityToken([tokenA, tokenB]: [ERC20Token, ERC20Token]): ERC20Token {
  return new ERC20Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'Verto-LP', 'Verto LPs')
}
