...
import { Modal, ModalBody, Text, Button, Flex, InjectedModalProps } from '@verto/uikit'
...
const TransactionsModal: React.FC<React.PropsWithChildren<InjectedModalProps>> = ({ onDismiss }) => {
  ...
  return (
    <Modal title={t('Recent Transactions')} headerBackground="backgroundAlt" onDismiss={onDismiss}>
      {account ? (
        <ModalBody>
          {hasTransactions ? (
            <>
