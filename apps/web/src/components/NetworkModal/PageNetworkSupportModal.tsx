...
export function PageNetworkSupportModal() {
  ...
  return (
    <Modal title={title || t('Check your network')} hideCloseButton headerBackground="backgroundAlt">
      <Grid style={{ gap: '16px' }} maxWidth="360px">
        <Text bold>{t('It’s a Rebus Chain only feature')}</Text>
        ...
        <Text small>
          {t(
            'Our Pools, Limit, Trading Competition, Prediction, Lottery and NFTs features are currently available only on Rebus Chain! Come over and join the community in the fun!',
          )}
        </Text>
        {canSwitch ? (
          <Button
