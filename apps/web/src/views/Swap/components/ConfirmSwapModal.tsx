...
import { Trade, Currency, TradeType, CurrencyAmount } from '@verto/sdk'
import { InjectedModalProps, LinkExternal, Text } from '@verto/uikit'
    ...
    <TransactionErrorContent
      message={
        <>
          ...
          <LinkExternal
            href="https://docs.vertotrade.com/products/vertotrade-exchange/trade-guide"
