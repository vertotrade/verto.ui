    ...
    <Box width="100%">
      ...
      <Flex justifyContent="center" alignItems="center" flexDirection={['column', 'column', 'row']}>
        ...
        <Flex maxWidth="300px" flexDirection="column">
          ...
          <Text>
            {t('Check our in-depth guide on')} {/* ToDo: update this to the verto lottery link */}
            <InlineLink href="https://docs.vertotrade.com/tokenomics/">
              {t('how to play the VERTO lottery!')}
            </InlineLink>
          </Text>
        </Flex>
      </Flex>
