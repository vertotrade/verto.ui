...
import { Heading, Text, Button, ArrowForwardIcon, Link, PageHeader, Pool } from '@verto/uikit'
...
const MigrationPage: React.FC<React.PropsWithChildren> = () => {
  ...
  const steps: Step[] = [
    {
      ...
      canHover: true,
      text: t('Unstake LP tokens and VERTO from the old MasterChef contract.'),
    },
    {
      stepId: ProgressStepsType.STEP2,
      canHover: true,
      text: t('Stake LP tokens and VERTO to the new MasterChef v2 contract.'),
    },
  ]
  ...
  const v1Pools = useMemo(() => {
    ...
    const cakeAutoVault = { ...cakePool, vaultKey: VaultKey.RebusVaultV1 }
  ...
  return (
    <div ref={tableWrapperEl}>
      <PageHeader>
        ...
        <Link href="https://docs.vertotrade.com/code/migration/migrate-your-stakings" external>
