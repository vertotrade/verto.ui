...
import { Text, TokenPairImage as UITokenPairImage, useMatchBreakpoints, Pool } from '@verto/uikit'
...
const NameCell: React.FC<React.PropsWithChildren<NameCellProps>> = ({ pool }) => {
  ...
  if (vaultKey) {
    ...
    title = t('Manual VERTO')
    subtitle = `${t('Earn')} VERTO ${t('Stake').toLocaleLowerCase()} VERTO`
  }
