...
import { Text, Button, useMatchBreakpoints } from '@verto/uikit'
...
const MigrationSticky: React.FC<React.PropsWithChildren<MigrationStickyProps>> = ({ step, handleClick }) => {
  ...
  const title: string = isStep1 ? t('Unstaking LP Tokens and VERTO') : t('Stake in the new contract.')
  const subTitle: string = isStep1
    ? t('All the earned VERTO will be harvested to your wallet upon unstake.')
