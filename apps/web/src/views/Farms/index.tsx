...
import { LinkExternal, ModalV2 } from '@verto/uikit'
    ...
    <ModalV2 isOpen={isBloctoETH && !close} closeOnOverlayClick={false}>
      <DisclaimerModal
        ...
        header={
          <>
            {t(
              'Crosschain farming on Ethereum does NOT support Blocto wallet, as you won’t be able to harvest VERTO rewards.',
            )}
