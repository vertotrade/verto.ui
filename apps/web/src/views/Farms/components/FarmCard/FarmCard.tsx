...
import { Card, Farm as FarmUI, Flex, Skeleton, Text, ExpandableSectionButton } from '@verto/uikit'
...
const FarmCard: React.FC<React.PropsWithChildren<FarmCardProps>> = ({
  ...
  const earnLabel = farm.dual ? farm.dual.earnLabel : t('VERTO + Fees')
  ...
  const isPromotedFarm = farm.token.symbol === 'VERTO'
