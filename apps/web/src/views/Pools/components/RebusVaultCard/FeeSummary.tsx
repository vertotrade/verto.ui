import { Text, Flex, useTooltip, TooltipText } from '@verto/uikit'
...
const FeeSummary: React.FC<React.PropsWithChildren<FeeSummaryProps>> = ({
  ...
  const { targetRef, tooltip, tooltipVisible } = useTooltip(
    <>
      ...
      <Text>
        {t(
          'Only applies within %num% days of staking. Unstaking after %num% days will not include a fee. Timer resets every time you stake new VERTO in the pool.',
          {
