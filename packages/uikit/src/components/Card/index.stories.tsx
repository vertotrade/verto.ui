...
export const CardHeader: React.FC<React.PropsWithChildren> = () => {
  ...
  const gradientBorderColor = `linear-gradient(transparent ${gradientStopPoint}, ${theme.colors.cardBorder} ${gradientStopPoint}), ${theme.colors.backgroundAlt}`;
  return (
    <div style={{ padding: "32px", width: "500px" }}>
      <Row>
      ...
      <Row>
        <Card borderBackground={gradientBorderColor}>
          <Box background={theme.colors.backgroundAlt} p="16px" height={headerHeight}>
