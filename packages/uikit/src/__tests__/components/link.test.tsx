...
it("renders link correctly", () => {
  const { asFragment } = renderWithProvider(<Link href="https://dev.vertotrade.com">Link</Link>);
...
it("renders link external link correctly", () => {
  const { asFragment } = renderWithProvider(<LinkExternal href="https://dev.vertotrade.com">Link</LinkExternal>);
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      .c2 {
